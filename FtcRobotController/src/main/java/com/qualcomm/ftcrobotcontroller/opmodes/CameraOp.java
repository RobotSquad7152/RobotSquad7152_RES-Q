...
public class CameraOp extends OpMode {
    ...
    public void init() {
        ...
        DbgLog.msg("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        camera = ((FtcRobotControllerActivity)hardwareMap.appContext).camera;
        DbgLog.msg("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
        camera.setPreviewCallback(previewCallback);
        DbgLog.msg("ccccccccccccccccccccccccccccccccccc");

        Camera.Parameters parameters = camera.getParameters();
        DbgLog.msg("dddddddddddddddddddddddddddddddddddddd");
        data = parameters.flatten();
        DbgLog.msg("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
